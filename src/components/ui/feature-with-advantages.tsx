    ...
    <div className="w-full py-20 lg:py-0">
      <div className="container mx-auto px-4">
        <div className="flex gap-4 py-20 flex-col items-start lg:py-0">
          <div>
            <Badge className="bg-sky-300/20 text-sky-200 border-sky-300/30 backdrop-blur-sm">О художнике</Badge>
          </div>
          <div className="flex gap-2 flex-col">
            ...
            <p className="text-lg max-w-xl lg:max-w-xl leading-relaxed tracking-tight text-sky-100 font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
          ...
          <div className="flex gap-10 pt-12 flex-col w-full">
            <div className="grid grid-cols-2 items-start lg:grid-cols-3 gap-10">
              <div className="flex flex-row gap-6 w-full items-start">
                <Heart className="w-[1.05rem] h-[1.05rem] mt-2 text-sky-300" strokeWidth={3} />
                <div className="flex flex-col gap-1">
                  <p className="text-white font-open-sans-custom">Художник</p>
                  <p className="text-sky-200 text-sm font-open-sans-custom">
              ...
              <div className="flex flex-row gap-6 w-full items-start">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sky-200 text-sm font-open-sans-custom">Канал @Cool_Desski4 - арты и обновления.</p>
                </div>
              </div>
              <div className="flex flex-row gap-6 items-start">
                <Heart className="w-[1.05rem] h-[1.05rem] mt-2 text-sky-300" strokeWidth={3} />
